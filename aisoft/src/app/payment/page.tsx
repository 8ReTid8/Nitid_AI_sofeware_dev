...
//       <h1 className="text-2xl font-bold mb-6">Payment Center</h1>
...
//                 <div
//                   key={bill.id}
//                   className={`card bg-base-100 cursor-pointer transition-all hover:bg-base-200 ${
//                     selectedBill?.id === bill.id ? 'border-2 border-primary' : 'border border-base-300'
//                   }`}
