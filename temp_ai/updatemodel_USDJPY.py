...
# กำหนดโฟลเดอร์โมเดล
# MODEL_DIR = "./temp_ai/model/USDJPY/"
MODEL_DIR = "./model/USDJPY/"
...
def retrain_model():
    ...
    # df = get_new_data()
    df = fetch_ohlc_data(symbol="USDJPY=X")
    if df is None:
    ...
    notify_model_update("USDJPY", new_version,path,win_rate,profit_factor,max_drawdown)
...
def main():
    ...
    logging.info("update USDJPY RUNNING")
    global best_model
